...
typedef struct ISLevelDBOptions {
...
typedef NSData * (^ISLevelDBEncoderBlock) (ISLevelDBKey * key, id object);
typedef id       (^ISLevelDBDecoderBlock) (ISLevelDBKey * key, id data);

typedef void     (^ISLevelDBKeyBlock)     (ISLevelDBKey * key, BOOL *stop);
typedef void     (^ISLevelDBKeyValueBlock)(ISLevelDBKey * key, id value, BOOL *stop);

typedef id       (^ISLevelDBValueGetterBlock)  (void);
typedef void     (^ISLevelDBLazyKeyValueBlock) (ISLevelDBKey * key, ISLevelDBValueGetterBlock lazyValue, BOOL *stop);

FOUNDATION_EXPORT NSString * const kISLevelDBChangeType;
FOUNDATION_EXPORT NSString * const kISLevelDBChangeTypePut;
FOUNDATION_EXPORT NSString * const kISLevelDBChangeTypeDelete;
FOUNDATION_EXPORT NSString * const kISLevelDBChangeValue;
FOUNDATION_EXPORT NSString * const kISLevelDBChangeKey;
FOUNDATION_EXPORT NSString * const kISLevelDBErrorOccurredNotification;
 ...
 */
@property (nonatomic, copy) ISLevelDBEncoderBlock encoder;

/**
 The data decoding block.
 */
@property (nonatomic, copy) ISLevelDBDecoderBlock decoder;
 ...
 */
+ (id) databaseInLibraryWithName:(NSString *)name andOptions:(ISLevelDBOptions)opts;
